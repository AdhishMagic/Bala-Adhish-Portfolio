    ...
    <section className="py-16 sm:py-20 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="container-width">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-gradient mb-4">Professional Assets</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {downloadableAssets?.map((asset) => {
            ...
            return (
              <div
                key={asset?.id}
                className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-border hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
                {/* Header */}
                <div className="text-center mb-6">
                  <div className={`w-14 h-14 sm:w-16 sm:h-16 ${colorClasses?.bg} rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg`}>
                    <Icon name={asset?.icon} size={24} sm:size={28} color="white" />
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold text-text-primary mb-2">{asset?.title}</h3>
                  <p className="text-sm sm:text-base text-text-secondary leading-relaxed">{asset?.description}</p>
                </div>
                {/* File Info */}
        ...
        {/* Download Statistics */}
        <div className="mt-16 bg-hero-gradient rounded-2xl p-8 lg:p-12 text-white relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="relative z-10 text-center">
            ...
            <h3 className="text-2xl sm:text-3xl font-bold mb-4">Professional Impact</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-3xl sm:text-4xl font-bold mb-2">{downloadStats?.resume + downloadStats?.portfolio + downloadStats?.references}</div>
