...
const DownloadSection = () => {
  ...
  return (
        <section className="py-4 sm:py-5 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        

        {/* Additional Resources */}
        <div className="bg-white rounded-2xl p-8 sm:p-10 lg:p-12 shadow-lg border border-border">
