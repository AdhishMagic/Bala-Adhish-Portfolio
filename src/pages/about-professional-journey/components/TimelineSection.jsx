            ...
            {timelineData?.[activeTab]?.map((item, index) => (
              ...
              >
                ...
                <div className={`w-full md:w-5/12 pl-20 md:pl-0 ${index % 2 === 0 ? 'md:pr-8' : 'md:pl-8 md:ml-auto'}`}>
                  <div className="bg-card border border-border rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium mb-2 sm:mb-0 ${item?.color === 'primary' ? 'bg-primary/10 text-primary' :
